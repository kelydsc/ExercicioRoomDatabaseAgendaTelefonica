package br.com.digitalhouse.exercicioroomdatabaseagendatelefonica.adapters;
...
public class RecyclerViewContatosAdapter extends RecyclerView.Adapter<RecyclerViewContatosAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(
                R.layout.recyclerview_contato_item, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Contato contato) {
            ...
            textViewTelefone.setText(textViewTelefone.getContext().getString(
                    R.string.tefefone_format, contato.getTelefone()));
        }
    }
}